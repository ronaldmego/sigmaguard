...
const RULES = [
  {
    ...
    description: "Block any single transaction above $50",
  ...
  },
  {
    ...
    description: "Total daily spending cannot exceed $100",
    config: { daily_cap: 100 },
    is_active: true,
    priority: 20,
  },
  {
  ...
  },
  {
    ...
    description: "Gambling transactions capped at $10",
    config: { category: "gambling", max_amount: 10 },
    is_active: true,
    priority: 40,
  },
  {
